...
TW = {
    "2025/23721": (15679, 37580),
    "2025/24021": (15685, 37586),
    "2025/34001": (17892, 39793),
    "2025/3669": (11627, 33528),
    "2025/40814": (18712, 40613),
    "2025/45563": (20033, 41934),
    "2025/50491": (21226, 43127),
    "2026/10726": (83751, 83987),
    "2026/10892": (84204, 84494),
    "2026/11981": (84414, 84704),
    "2026/12103": (86845, 89337),
    "2026/12145": (86084, 88576),
    "2026/12208": (86079, 88571),
    "2026/12314": (86180, 88672),
    "2026/12435": (86274, 88766),
    "2026/12483": (86200, 88692),
    "2026/12806": (86267, 88759),
    "2026/13383": (86371, 88863),
    "2026/13421": (86380, 88872),
    "2026/13949": (86667, 89159),
    "2026/14121": (86529, 89021),
    "2026/14441": (86609, 89101),
    "2026/14662": (86629, 89121),
    "2026/15721": (86763, 89255),
    "2026/16662": (86839, 89331),
    "2026/16864": (86981, 89473),
    "2026/16922": (87172, 89664),
    "2026/17382": (87141, 89633),
    "2026/17649": (87140, 89632),
    "2026/3145": (48017, 48415),
    "2026/4408": (48743, 49082),
    "2026/5962": (76628, 76674),
    "2026/6301": (76609, 76655),
    "2026/7581": (85055, 87547),
    "2026/8487": (85222, 87714),
    "2026/9064": (85457, 87949),
    "2026/9140": (85343, 87835),
    "2026/9192": (85603, 88095),
    "2026/9267": (85489, 87981),
}
KIND = {
    "2025/23721": "Premios",
    "2025/24021": "Premios",
    ...
    "2025/50491": "Premios",
    "2026/10726": "Otros",
    "2026/10892": "Empleo Publico",
    "2026/11981": "Ayudas",
    "2026/12103": "Otros",
    "2026/12145": "Becas",
    "2026/12208": "Ayudas",
    "2026/12314": "Empleo Publico",
    "2026/12435": "Empleo Publico",
    "2026/12483": "Empleo Publico",
    "2026/12806": "Ayudas",
    "2026/13383": "Otros",
    "2026/13421": "Subvenciones",
    "2026/13949": "Becas",
    "2026/14121": "Empleo Publico",
    "2026/14441": "Otros",
    "2026/14662": "Otros",
    "2026/15721": "Ayudas",
    "2026/16662": "Otros",
    "2026/16864": "Otros",
    "2026/16922": "Empleo Publico",
    "2026/17382": "Premios",
    "2026/17649": "Subvenciones",
    "2026/3145": "Empleo Publico",
    "2026/4408": "Subvenciones",
    "2026/5962": "Subvenciones",
    "2026/6301": "Subvenciones",
    "2026/7581": "Empleo Publico",
    "2026/8487": "Premios",
    "2026/9064": "Subvenciones",
    "2026/9140": "Otros",
    "2026/9192": "Subvenciones",
    "2026/9267": "Otros",
}
    ...
    ITEMS.append(
        {
            ...
            "perturbation": pert,
            "question": q,
            "expected_answer": None if abstain else expected,
            "should_abstain": abstain,
            "gold_sets": gold_sets,
            "doc_ids": doc_ids,
            "gold_refs": [] if abstain else refs,
            "gold_chunk": chunk,
            "doc_kind": dkind,
            "text_source": dsrc,
        }
...
add(
    ...
    ["2026/3145"],
    chunk="chunk 4 (tabla A1=1.366,74); chunk 1 (subida 2,5%)",
)
add(
    "v2-002",
    "va",
...
add(
    ...
    ["2026/12314"],
    chunk="chunk 2 (33 modalidades / 33 docentes)",
)
add(
    "v2-004",
    "va",
    ...
    ["2026/5962"],
    chunk="chunk 4 (ficción 4.860.000)",
)
add(
    "v2-005",
    "es",
...
add(
    ...
    ["2026/12145"],
    chunk="chunk 4 (1.600.000 €; 800/400)",
)
add(
    "v2-008",
    "va",
    ...
    ["2026/14121"],
    chunk="chunk 6 (30,57 / 25,48; bonif 10%)",
)
add(
    "v2-009",
    "es",
    ...
    ["2026/14662"],
    chunk="chunk 0 (Daniel González Serisola)",
)
add(
    "v2-010",
    "va",
...
add(
    ...
    ["2026/15721"],
    chunk="anexo I, chunk 4 (Pureza de María Grao 36.065,80)",
)
add(
    "v2-012",
    "va",
    ...
    ["2026/12806"],
    chunk="anexo, chunk 5 (Alaquàs 261.560 €)",
)
add(
    "v2-013",
    "es",
    ...
    ["2025/23721"],
    chunk="anexo I, chunk 2 (ABAD SANJUAN NESTOR 6.000 €)",
)
add(
    "v2-014",
    "va",
    ...
    ["2025/40814"],
    chunk="anexo, chunk 1 (AGENJO TRIGOS JAIRO TAEKWONDO 2.250 €)",
)
add(
    "v2-015",
    "es",
    ...
    ["2026/12208"],
    chunk="chunk 1 (90%; 758.679,57 -> 670.301,61)",
)
add(
    "v2-016",
    "va",
...
add(
    ...
    ["2025/34001"],
    chunk="chunk 2 (75.000; 51.637,24)",
)
add(
    "v2-018",
    "va",
    ...
    ["2026/11981"],
    chunk="chunk 1 (22.255.556,00; 60% FEADER)",
)
add(
    "v2-019",
    "es",
    ...
    ["2026/4408"],
    chunk="chunk 6 (Moros y Cristianos 25 / 46.000 €)",
)
add(
    "v2-020",
    "va",
    ...
    ["2026/6301"],
    chunk="chunk 2 (hasta 10 marzo 2026); chunk 4 (50%)",
)
...
add(
    ...
    ["2026/14121", "2026/12483"],
    chunk="convocatorias OPE 2026",
)
add(
    "v2-022",
    "va",
    ...
    ["2026/12806"],
    chunk="Fondo Cooperación Municipal 2026",
)
add(
    "v2-023",
    "es",
    ...
    ["2026/13949", "2026/12145"],
    chunk="becas universitarias 2026",
)
add(
    "v2-024",
    "va",
...
add(
    ...
    ["2026/9064", "2026/5962"],
    chunk="IVC subvenciones cultura",
)
add(
    "v2-027",
    "es",
...
add(
    ...
    ["2026/12103"],
    chunk="Decreto 73/2026 nombramiento",
)
add(
    "v2-030",
    "va",
...
add(
    ...
    ["2025/40814"],
    chunk="becas deportistas élite 2025",
)
add(
    "v2-032",
    "va",
...
add(
    ...
    ["2026/17382"],
    chunk="premio President fallas 2026 5.000",
)
add(
    "v2-034",
    "va",
...
add(
    ...
    ["2026/16662"],
    chunk="nombramiento presidente CACVSA",
)
...
add(
    ...
    ["2025/3669"],
    chunk="Decreto 167/2024 (no 167/2025)",
)
add(
    "v2-043",
    "es",
...
add(
    ...
    ["2025/24021", "2026/17382"],
    both=True,
    chunk="premio President 5.000 ambos años",
)
add(
    "v2-049",
    "es",
...
add(
    ...
    ["2026/5962", "2026/9064"],
    both=True,
    chunk="IVC audiovisual vs música",
)
add(
    "v2-051",
    "es",
    ...
    ["2025/3669", "2026/12806"],
    both=True,
    chunk="DANA alquiler + Fondo Cooperación",
)
add(
    "v2-052",
    "va",
    ...
    ["2026/14662", "2026/16864"],
    both=True,
    chunk="gerente UV + vocales CVU",
)
...
add(
    ...
    ["2026/13421"],
    chunk="2024-2026; Juan Martínez Caballero",
)
add(
    "v2-056",
    "va",
...
add(
    ...
    ["2025/45563"],
    chunk="ocho becas; Decreto 20/2017",
)
add(
    "v2-058",
    "va",
...
add(
    ...
    ["2026/12314"],
    chunk="chunk 4 (15 días; cv_skills@gva.es)",
)
...
add(
    ...
    ["2025/3669"],
    chunk="anexo, chunk 5 (INETA BARDZILAUSKAITE 11.200)",
)
add(
    "v2-062",
    "va",
    ...
    ["2026/15721"],
    chunk="anexo I, chunk 4 (La Malvesia Llombai 3.796,40)",
)
add(
    "v2-063",
    "es",
    ...
    "235.896 €.",
    ["2026/12806"],
    chunk="anexo, chunk 5 (Alboraia 235.896)",
)
add(
    "v2-064",
    "va",
    ...
    "2.500 € (annex I).",
    ["2025/23721"],
    chunk="anexo I, chunk 2 (ADAN LLEDO CLAUDIA VELA 2.500)",
)
...
add(
    ...
    [],
    abstain=True,
    chunk="Teruel/Aragón, fuera de la C.Valenciana",
)
add(
    "v2-067",
    "es",
...
add(
    ...
    [],
    abstain=True,
    chunk="no es contingut del DOGV",
)
add(
    "v2-071",
    "es",
    ...
    [],
    abstain=True,
    chunk="meteorología, fuera de ámbito",
)
add(
    "v2-072",
    "va",
    ...
    [],
    abstain=True,
    chunk="convenio empresa estatal, no DOGV autonómico",
)
add(
    "v2-073",
    "es",
...
add(
    ...
    [],
    abstain=True,
    chunk="sense sentit / fora d'àmbit",
)
...
add(
    ...
    ["2026/13421"],
    chunk="plan estratégico 2024-2026",
)
add(
    "v2-078",
    "va",
    ...
    ["2026/5962"],
    chunk="audiovisual; videojocs 30.000",
)
add(
    "v2-079",
    "es",
...
add(
    ...
    ["2026/4408"],
    chunk="1r premi 5.000; total 88.500",
)
add(
    "v2-082",
    "va",
    ...
    ["2026/16864"],
    chunk="Pilar Chiva / Enrique Vidal",
)
add(
    "v2-083",
    "es",
...
add(
    ...
    ["2026/9064"],
    chunk="chunk 6 (1 diciembre 2025)",
)
add(
    "v2-086",
    "va",
    ...
    ["2026/10892"],
    chunk="chunk 7 (Alberto Colom Alcácer)",
)
add(
    "v2-087",
    "es",
    ...
    ["2026/17382"],
    chunk="chunk 1 (Espartero-Gran Vía)",
)
add(
    "v2-088",
    "va",
...
add(
    ...
    ["2026/12145"],
    chunk="curso 2024-2025 (no 2025-2026)",
)
add(
    "v2-091",
    "es",
    ...
    ["2025/40814"],
    chunk="Orden 59/2016 (no Decreto)",
)
add(
    "v2-092",
    "va",
    ...
    ["2026/12435"],
    chunk="ejercicio 2026, 64 puestos",
)
...
add(
    ...
    ["2026/8487", "2026/17382"],
    both=True,
    chunk="convocatoria + concesión fallas 2026",
)
add(
    "v2-094",
    "va",
    ...
    ["2026/14121", "2026/3145"],
    both=True,
    chunk="tasa examen + sueldo A1",
)
add(
    "v2-095",
    "es",
    ...
    ["2025/34001", "2025/40814"],
    both=True,
    chunk="UNED + deportistas élite",
)
...
add(
    ...
    ["2026/9192"],
    chunk="chunk 4 (775.000; 1.250.000)",
)
add(
    "v2-098",
    "va",
    ...
    ["2026/16922"],
    chunk="oferta pública plazas investigación UV",
)
add(
    "v2-099",
    "es",
    ...
    ["2026/7581"],
    chunk="profesorado ayudante doctor UA",
)
add(
    "v2-100",
    "va",
    ...
    ["2026/12103"],
    chunk="cese Zaragosí a petición propia",
)
    ...
    retrieval = [
        {
            "id": i["id"],
            "question": i["question"],
            "gold_sets": i["gold_sets"],
            "doc_ids": i["doc_ids"],
            "language": i["language"],
            "category": i["category"],
            "doc_kind": i["doc_kind"],
            "text_source": i["text_source"],
        }
        for i in ITEMS
        if not i["should_abstain"]
    ]
