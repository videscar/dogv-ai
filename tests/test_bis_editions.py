...
def test_search_strips_punctuation_and_caps_to_16_words(monkeypatch):
    ...
    title = "ORDEN 4/2025, de 30 de octubre de 2025, de la Vicepresidencia Primera y " \
...
def test_missing_sibling_picks_ordinary_when_ingested_is_bis(monkeypatch):
    ...
    monkeypatch.setattr(bis, "existing_refs", lambda refs, lang: {"2025/1"})  # 2025/1 already present
    monkeypatch.setattr(bis, "resolve_signatura_ids", lambda missing, titles, lang: {s: 900 for s in missing})
